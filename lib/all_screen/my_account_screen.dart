             ...
             child: Column(
               ...
               children: [
                 InkWell(
                             ...
                             child: Column(
                               ...
                               children: <Widget>[
                                 ...
                                 InkWell(
                                     ...
                                     child: CommonButton(txt1: 'Confirm'.tr,containcolore: const Color(0xff7D2AFF),context: context)),
                   ...
                   child: ListTile(
                     leading: Transform.translate(offset: const Offset(-25, 0),child: CircleAvatar(backgroundColor: Colors.grey.withOpacity(0.2),radius: 35,child: Text(userData['name'][0],style: const TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Color(0xff7D2AFF))),)),
                     ...
                     trailing: const Image(image: AssetImage('assets/pen-line.png'),height: 25,width: 25,color: Color(0xff7D2AFF)),
                   ),
                 ),
                 const SizedBox(height: 10,),
                                               ...
                                               itemBuilder: (context, index) {
                                                 return GestureDetector(
                                                   ...
                                                   child: Container(
                                                     ...
                                                     decoration: BoxDecoration(
                                                         border: Border.all(color: value == index ? const Color(0xff7D2AFF) : Colors.transparent,),
                           ...
                           child: Padding(
                             ...
                             child: Column(
                               ...
                               children: <Widget>[
                                 ...
                                 Text('Delete Account'.tr,style: const TextStyle(color: Color(0xff7D2AFF),fontWeight: FontWeight.bold,fontSize: 20)),
                                 ...
                                 Row(
                                   ...
                                   children: [
                                     ...
                                     ElevatedButton(
                                       style: ButtonStyle(fixedSize: const MaterialStatePropertyAll(Size(130, 40)),elevation: const MaterialStatePropertyAll(0),shape: MaterialStatePropertyAll(RoundedRectangleBorder(borderRadius: BorderRadius.circular(10))),backgroundColor: const MaterialStatePropertyAll(Color(0xff7D2AFF))),
                                       onPressed: () => {
                                         // resetNew(),
                       ...
                       builder: (BuildContext context) {
                         return Container(
                           ...
                           child: Column(
                             ...
                             children: <Widget>[
                               const SizedBox(height: 25,),
                               Text('Logout'.tr,style: const TextStyle(color: Color(0xff7D2AFF),fontWeight: FontWeight.bold,fontSize: 20)),
                               const SizedBox(height: 25,),
                               ...
                               Row(
                                 ...
                                 children: [
                                   ...
                                   const SizedBox(width: 10,),
                                   ElevatedButton(
                                     style: ButtonStyle(fixedSize: const MaterialStatePropertyAll(Size(120, 40)),elevation: const MaterialStatePropertyAll(0),shape: MaterialStatePropertyAll(RoundedRectangleBorder(borderRadius: BorderRadius.circular(10))),backgroundColor: const MaterialStatePropertyAll(Color(0xff7D2AFF))),
                                     onPressed: () => {
                                       resetNew(),
                                       Navigator.push(context, MaterialPageRoute(builder: (context) => const Login_Screen(),))
                                     },
...
//my wallet,refer and earn,delet account
