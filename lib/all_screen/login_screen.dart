  ...
  Future _signInWithMobileNumber() async {
    try{
      await _auth.verifyPhoneNumber(
        phoneNumber: "+92${mobileController1.text.trim()}",
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Welcome To RidyHop'.tr,style:  TextStyle(fontFamily: 'SofiaProBold',fontSize: 16,color: notifier.textColor)),
            ...
            children: [
              ...
              Column(
                children: [
                  ...
                  Text('RidyHop'.tr,style: const TextStyle(color: Color(0xff7B2BFF),fontSize: 20,fontFamily: 'SofiaProBold'),),
                ],
              ),
