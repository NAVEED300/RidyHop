          ...
          bottomNavigationBar: BottomNavigationBar(
            ...
            items:  <BottomNavigationBarItem>[
              BottomNavigationBarItem(
                icon: homeController.selectpage == 0 ? const Padding(
                  padding: EdgeInsets.only(bottom: 5),
                  child: Image(image: AssetImage('assets/Bottom Fill Home.png'),height: 22,width: 22,),
                ): const Padding(
                  padding: EdgeInsets.only(bottom: 5),
              ...
              BottomNavigationBarItem(
                icon: homeController.selectpage == 1 ? const Padding(
                  padding: EdgeInsets.only(bottom: 5),
                  child: Image(image: AssetImage('assets/Bottom Fill Fill Ticket.png'),height: 24,width: 24,),
                ):const Padding(
                  padding: EdgeInsets.only(bottom: 5),
              ...
              BottomNavigationBarItem(
                icon: homeController.selectpage == 2 ? const Padding(
                  padding: EdgeInsets.only(bottom: 5),
                  child: Image(image: AssetImage('assets/Bottom Fill Wallet.png'),height: 19,width: 19,),
                ):const Padding(
                  padding: EdgeInsets.only(bottom: 5),
              ...
              BottomNavigationBarItem(
                icon:homeController.selectpage == 3 ? const Padding(
                  padding: EdgeInsets.only(bottom: 5),
                  child: Image(image: AssetImage('assets/Bottom Fill Account.png'),height: 20,width: 20,),
                ):const Padding(
                  padding: EdgeInsets.only(bottom: 5),
            ...
            selectedItemColor: const Color(0xff7D2AFF),
            onTap: _onItemTapped,
          ),
          body: Center(
