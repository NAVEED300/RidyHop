  ...
  Future _signInWithMobileNumber() async {
    try{
      await _auth.verifyPhoneNumber(
       ...
       Navigator.push(context, MaterialPageRoute(builder: (context) => Otp_Screen(verificationId: verificationId,ccode: ccode,email: emailController.text,name: nameController.text,mobile: mobileController.text,password: passwordController.text,rcode: rcodeController.text,),))  ;
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 20,),
                        // CommonTextfiled2(txt: '   Enter A REFERRAL CODE'),
                        // const SizedBox(height: 20,),
                        ...
                        InkWell(
                            ...
                            child: CommonButton(txt1: 'GENERATE OTP', txt2: '(ONE TIME PASSWORD)',containcolore: const Color(0xff7D2AFF),context: context)),
                        ...
                        //     onPressed: () {
                        //       if(nameController.text.isNotEmpty && emailController.text.isNotEmpty && mobileController.text.isNotEmpty && passwordController.text.isNotEmpty){
                        //         signupapi(nameController.text, emailController.text, emailController.text,mobileController.text,passwordController.text,).then((value) {
                        //           print("+++++++++++++${value}");
                        //           if(value["ResponseCode"] == "200"){
                        //             ScaffoldMessenger.of(context).showSnackBar(
                        //               SnackBar(content: Text(value["ResponseMsg"]), behavior: SnackBarBehavior.floating, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),),
