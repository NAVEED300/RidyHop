...
List seledctSite = [];
                  ...
                  Row(
                    ...
                    children: [
                      data!.busLayoutData[0].upperLayout.isEmpty ? Column(
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  Text('-(${selectset.length}) -'.tr,style:  TextStyle(color: notifier.textColor,fontSize: 15),),
                                ],
                              ),
                              Text(selectset.join(","),style:  TextStyle(color: notifier.textColor,fontSize: 15),),
                            ],
                          ),
                        ],
                      ):Column(
                        crossAxisAlignment:  CrossAxisAlignment.start,
                        children: [
                          selectset.isEmpty?  const SizedBox(): Row(
                            children: [
                              Row(
                                children: [
                                  Text('Lower Seat'.tr,style:  TextStyle(color: notifier.textColor,fontSize: 15),),
                          ...
                          selectset1.isEmpty?  const SizedBox(): Row(
                            children: [
                              Row(
                                children: [
                                  Text('Upper Seat'.tr,style:  TextStyle(color: notifier.textColor,fontSize: 15),),
                                  Text('-(${selectset1.length}) -'.tr,style:  TextStyle(color: notifier.textColor,fontSize: 15),),
                                ],
                              ),
                              Text(selectset1.join(","),style:  TextStyle(color: notifier.textColor,fontSize: 15),),
                            ],
                          ),
                        ],
                      ),
                      ...
                      const SizedBox(width: 10,),
                       // Text('${selectset.join(",") +',' "${selectset1.join(",")}"}'),
                      const Spacer(),
                      // const Image(image: AssetImage('assets/ruppe_image.png'),height: 15,width: 15,),
                      // const SizedBox(width: 5,),
                      Text("${widget.currency} $bottom",style:  TextStyle(color: notifier.textColor,fontWeight: FontWeight.bold,fontSize: 17)),
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    data!.busLayoutData[0].upperLayout.isEmpty ?   Container(
                                        ...
                                        itemBuilder: (BuildContext context, int index) {
                                          ...
                                          return data?.busLayoutData[0].lowerLayout[index1][index].seatNumber == "" ?  Container(
                                            ...
                                            onTap: () {
                                              ...
                                              setState(() {
                                                ...
                                                if(data!.busLayoutData[0].lowerLayout[index1][index].isBooked) {
                                                  ...
                                                  //   SnackBar(content: const Text('Booked by Others'),behavior: SnackBarBehavior.floating, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),),
                                                  // );
                                            ...
                                            child:  widget.isSleeper == '1' ?    Container(
                                              ...
                                              decoration: BoxDecoration(
                                                // color: Colors.red,
                                                // color: selectset.contains(data!.busLayoutData[0].lowerLayout[index1][index].seatNumber)? Colors.green : Colors.transparent,
                                                // border: Border.all(color: selectset.contains(data!.busLayoutData[0].lowerLayout[index1][index].seatNumber)? Colors.transparent :Colors.green),
                                                // borderRadius: BorderRadius.circular(5),
                      ...
                      // height: 650,
                      width: widget.isSleeper == '1' ?   double.parse((50 * data!.busLayoutData[0].lowerLayout[0].length).toString()) : double.parse((58 * data!.busLayoutData[0].lowerLayout[0].length).toString()),
                      // width: 175 ,
                      decoration: BoxDecoration(
                          color: notifier.containercoloreproper,
                          borderRadius: BorderRadius.circular(5),
                                  ...
                                  return SizedBox(
                                    ...
                                    child: ListView.builder(
                                        ...
                                        itemBuilder: (BuildContext context, int index) {
                                         ...
                                         // print(data!.busLayoutData[0].lowerLayout[index1][index].isBooked);
                                         // print(data!.busLayoutData[0].lowerLayout[index1][index].seatNumber);
                                         // print(data!.busLayoutData[0].lowerLayout[index1][index].gender);
                                         // print(widget.bus_id);

                                         // log('${data!.busLayoutData[0].lowerLayout[index1][index].seatNumber}');
                                         // log('${data!.busLayoutData[0].lowerLayout[index1][index].isBooked}');
                                         // log('${data!.busLayoutData[0].lowerLayout[index1][index].gender}');
                                          ...
                                          return data?.busLayoutData[0].lowerLayout[index1][index].seatNumber == "" ?  Container(
                                            ...
                                            onTap: () {
                                              ...
                                              setState(() {
                                                ...
                                                if(data!.busLayoutData[0].lowerLayout[index1][index].isBooked) {
                                                  // ScaffoldMessenger.of(context).showSnackBar(
                                                  //   SnackBar(content: Text('Booked by Others'),behavior: SnackBarBehavior.floating, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),),
                                                  // );
                    ...
                    data!.busLayoutData[0].upperLayout.isEmpty ? const  SizedBox()  :  Container(
                      // height: 650,
                      width: widget.isSleeper == '1' ?  double.parse((50 * data!.busLayoutData[0].upperLayout[0].length).toString()) : double.parse((56 * data!.busLayoutData[0].upperLayout[0].length).toString()),
                                      ...
                                      physics: const NeverScrollableScrollPhysics(),
                                        ...
                                        itemBuilder: (BuildContext context, int index) {
                                          ...
                                          return data?.busLayoutData[0].upperLayout[index1][index].seatNumber == "" ? Container(
                                            ...
                                            // height: 60,
                                            width: widget.isSleeper == '1' ?  35 : 40,
                                                ...
                                                if(data!.busLayoutData[0].upperLayout[index1][index].isBooked) {
                                                 if (data!.busLayoutData[0].upperLayout[index1][index].gender == 'FEMALE'){
                                                  ...
                                                  if (selectset1.contains(
                                                      data!.busLayoutData[0]
                                                          .upperLayout[index1][index]
                                                          .seatNumber) ==
                                                      true) {
                                                    setState(() {

                                                      selectset1.remove(data!
                                                          .busLayoutData[0]
                                                          .upperLayout[index1][index]
                                                          .seatNumber);
                                                    });
                                                    ...
                                                    if (selectset1.length + selectset1.length == int.parse(data!.busLayoutData[0].bookLimit)) {
                                                      ScaffoldMessenger.of(
                                                          context)
                                                          .showSnackBar(
                                                        SnackBar(
                                                          content: Text('You can not add more than ${data!.busLayoutData[0].bookLimit} passengers to a single booking with this operator'),
  ...
  Widget upper(){
    return   Row(
      children: [
        // Text('Upper Berth',style: TextStyle(color: Colors.black),overflow: TextOverflow.ellipsis,maxLines: 1,),
        const Spacer(),
        const SizedBox(height: 30,width: 30,),
        // Image(image: AssetImage('assets/staring.png'),height: 30,width: 30,),
